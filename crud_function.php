...
$crud->insert("tblstudentclass", array("classid", "studentid", "cur_id", "gradelevel"), array($classid, $studentid, $cur_id, $gradelevel));
...
$crud->insert("usertbl", array("username", "password" ,"fname", "mname", "lname", "contact", "usertype", "profile_pic"), array($username, "student123", $firstname, $middlename, $lastname, $contact, "student", "images/man-28.png"));		
...
$crud->insert("tblclass", array("classname", "schoolyearid", "yearlevelid", "cur_id"), array($class_name, $school_year_id, $year_level_id, $cur_id));
...
$crud->update("tblclass", array("id", "classname", "schoolyearid", "yearlevelid", "cur_id"), array($classid, $className, $schoolyearid, $yearlevelid, $cur_id));
