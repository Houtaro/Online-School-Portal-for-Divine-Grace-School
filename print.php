		...
		if(!empty($_GET['classid']) && !empty($_GET['subid']) || $userType == 'student'){
			...
			if(mysqli_num_rows($result) > 0){
				...
				$user = mysqli_query($con, "SELECT *, CONCAT(s.lname, ', ', s.fname, ' ', s.mname) as sname from tblstudentclass sc
					...
					where sc.schoolyearid='$schoolyearid' group by s.id");
				...
				<h3 style="margin:10px 0px 10px 0px;"><b>Subject:</b> <?php echo $row['subjectname']." - ".$row['description']; ?></h3>
				<h3 style="margin:10px 0px 10px 0px;"><b>Section:</b> <?php echo $row['classname']; ?></h3>
				<table class="table"> 
					<tr>
						<th rowspan="2" style="padding:30px 0px 0px 0px;" class="text-center">Students</th>
				...
				<div class="pull-right">
					<h4 align="center" style="margin-bottom:20px;"><b>Prepared By:</b></h4>
