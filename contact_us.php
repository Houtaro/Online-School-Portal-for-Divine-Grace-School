        ...
        <div class="mbr-table">
          <div class="mbr-table-cell">
            <div class="navbar-brand">
              <a href="index.php" class="navbar-logo"><img src="assets/images/logo-128x128.png" alt="Mobirise"></a>
    ...
    <div class="row">
      ...
      <div class="mbr-footer-content col-xs-12 col-md-3">
        <p><strong>Address</strong><br>
          Sampaguita Street Maligaya Park Subdivision Novaliches, Novaliches<br>
          Quezon City, 1118 Metro Manila</p>
        </div>
        <div class="mbr-footer-content col-xs-12 col-md-3">
          <p><strong>Contacts</strong><br>
            Email: divinegraceschool@gmail.com<br>
            Telephone: 367-47-42 or 
            417-52-84 </p>
          </div>
          <div class="mbr-footer-content col-xs-12 col-md-3">
            <p><strong>Links</strong><br>
              <a class="text-primary" href="divinegraceschool.edu.ph">www.divinegraceschool.edu.ph</a>
            </div>
